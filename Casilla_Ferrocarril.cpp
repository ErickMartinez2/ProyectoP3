...
Casilla_Ferrocarril::Casilla_Ferrocarril(string pnombre, int palquiler, int palquiler2, int palquiler3, int palquiler4, int pprecio, bool pdisponible, int pnumero): Casilla(pnombre, palquiler, palquiler2, palquiler3, palquiler4, pprecio, pdisponible, pnumero) {
